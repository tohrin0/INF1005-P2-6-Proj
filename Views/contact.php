            ...
            <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="space-y-6">
                    ...
                    <button type="submit" name="submit_contact"
                        class="bg-blue-600 hover:bg-blue-800 text-white font-bold py-3 px-6 rounded-md transition-colors border border-black">
                        Send Message
                    </button>
                </form>
            </div>
            ...
            <div>
                ...
                <div class="bg-white rounded-xl shadow-md p-8 border border-gray-100">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="bg-gray-100 hover:bg-sky-100 text-gray-500 hover:text-sky-600 p-3 rounded-full transition-colors" aria-label="Twitter">
                            <i class="fab fa-facebook-f text-xl"></i>
                        </a>
                        <a href="#" class="bg-gray-100 hover:bg-sky-100 text-gray-500 hover:text-sky-600 p-3 rounded-full transition-colors" aria-label="Facebook">
                            <i class="fab fa-twitter text-xl"></i>
                        </a>
                        <a href="#" class="bg-gray-100 hover:bg-sky-100 text-gray-500 hover:text-sky-600 p-3 rounded-full transition-colors" aria-label="Instagram">
                            <i class="fab fa-instagram text-xl"></i>
                        </a>
                        <a href="#" class="bg-gray-100 hover:bg-sky-100 text-gray-500 hover:text-sky-600 p-3 rounded-full transition-colors" aria-label="Linkedin">
